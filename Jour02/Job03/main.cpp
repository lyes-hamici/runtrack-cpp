...
int main() {
    {
        ...
        // Afficher les Pingouins et leur vitesse de glisse
        std::cout << "Pingouins actuels dans le vecteur :" << std::endl;
        for (const auto& p : Pingouin::tousLesPingouins) {
            std::cout << p->getVitesseGlisse() << " m/s" << std::endl;
        }
    }
