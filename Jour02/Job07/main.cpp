...
int main() {
    ...
    // Gérer les compétences
        p1->ajouterCompetence("Attaque eclair", 5);
        p1->ajouterCompetence("Glisse", 4);
        p1->ajouterCompetence("Natation",1);
        p1->listerCompetences();

        p1->modifierCompetence("Glisse", 6);
        p1->supprimerCompetence("Natation");
        p1->listerCompetences();
    }
